			...
			<div id="sidebar-wrapper" className="my-sidebar sidebar-closed">
				...
				<div className="menu mt-5">
					...
					<ul className="nav flex-column">
						...
						<li >
							<NavLink to="/myevents/1" className="nav-link" activeClassName="nav-link-active" onClick={() => {this.sidebarClick(this)}}><i class="fas fa-list-alt"></i> <span className="toggleHidden">My Created Events</span></NavLink>
						</li>
						<li>
