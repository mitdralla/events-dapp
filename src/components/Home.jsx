	...
	render() {
		return(
			<div className="mt-5">
				...
				<hr />
				<p>The Hydro Events Marketplace DApp is a free service that provides ability to create events and sell tickets for them. Price for ticket can be in Ethereum or in USD Stable Token.</p>
